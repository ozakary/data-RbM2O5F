...
input_file = os.path.join(base_directory, '2nd_step_coulomb_energy_l.txt')
output_file = os.path.join(base_directory, 'RbX18_step-2_OF_dist_Rb_config-5_summary_l.csv')
