...
def generate_smooth_surface(input_file, elevation=25, azimuth=-125):
    ...
    # Set axis labels
#    ax.set_title('$^{93}$Nb $-$ RbNb$_2$O$_5$F (Only Mod. 2, 3, 4 & 8)', fontname = 'Times New Roman', fontsize = 26, y = 1)
    ...
    ax.text(x=70, y=0.5, z=5.5, s=r'$^{93}$Nb $-$ RbNb$_{2}$O$_{5}$F', color='#161616', fontsize=18)

    # Show the plot
    fig.savefig('th_3d_93Nb_dist_RbNb2O5F.svg', format='svg', dpi=300, bbox_inches='tight', pad_inches=0.7)
    plt.show()
...
# Example usage
input_file = 'figure_7-e_data.txt'  # replace with your actual input file path
