...
data_file = np.loadtxt("./figure_8-a_data.txt", skiprows=1)
labels = ['$f$ {$\delta_{iso}$ ; $^{19}F$}', '$f$ {$\delta_{CSA}$ ; $^{19}F$}', '$f$ {$C_Q$ ; $^{93}Nb$}',
          '$f$ {$\eta_Q$ ; $^{93}Nb$}', '$f$ {$\delta_{iso}$ ; $^{93}Nb$}', 
...
fig.savefig('RbNb2O5F_radars.svg', format='svg', dpi=300, bbox_inches='tight')
plt.show()
