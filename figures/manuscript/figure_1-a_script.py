...
def plot_experimental_spectrum(file_path, operating_frequency_mhz):
    ...
    ax.plot(
        experimental_data['Delta_ISO (ppm)'], 
        experimental_data['Intensity_Cont-1'] - 5000, 
        label='Line 1', 
        color='#2A9D8F'
    )
    ...
    ax.plot(
        experimental_data['Delta_ISO (ppm)'], 
        experimental_data['Intensity_Cont-2'] - 10000, 
        label='Line 2', 
        color='#E76F51'
    )
    ...
    ax.plot(
        experimental_data['Delta_ISO (ppm)'], 
        (experimental_data['Intensity_Exp'] - experimental_data['Intensity_Fit']) - 15000, 
...
if __name__ == "__main__":
    experimental_file = 'figure_1-a_data.asc'
