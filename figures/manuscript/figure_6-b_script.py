...
# Load the data
data_1 = pd.read_csv("./figure_6-b_data-1.csv")
data_2 = pd.read_csv("./figure_6-b_data-2.csv")
data_3 = np.loadtxt("./figure_6-b_data-3.txt", skiprows=1, usecols=range(1, 19 + 1))
...
bar_plot_31 = ax.bar(index[:7] + bar_width, Proba_conf(18)[:7] / 100, bar_width, color='#E76F51', alpha=1, label='Random')
...
plt.tight_layout()
fig.savefig('plot_configs_RbX18.svg', format='svg', dpi=300, bbox_inches='tight')
plt.show()

print(Proba_conf(18) / 100)
