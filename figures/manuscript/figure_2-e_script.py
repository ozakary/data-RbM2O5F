...
file_path_1 = './figure_2-e_data-1.asc'  # Path to the uploaded file
file_path_2 = 'figure_2-e_data-2.asc'  # Path to the uploaded file
...
num_contours_exp = 9  # Set this to the desired number of contour lines
num_contours_fit = 20  # Set this to the desired number of contour lines
...
ax_right.plot(np.sum(spectrum_2d_exp, axis=1) + 6000000, F1_axis_ppm, color='#264653', linewidth=2.5)
ax_right.plot(np.sum(spectrum_2d_fit, axis=1) + 20000000, F1_axis_ppm, color='red', linestyle='--')
ax_right.plot(np.sum(spectrum_2d_fit, axis=1) + 17000000, F1_axis_ppm, color='#2A9D8F')
ax_right.plot((np.sum(spectrum_2d_fit, axis=1) + 20000000 - np.sum(spectrum_2d_exp, axis=1) - 6000000) + 1500000, F1_axis_ppm, color='grey')
ax_right.set_xlim(0, 10500000)
