...
def plot_combined_and_experimental_spectrum(chunk_files, experimental_file, operating_frequency_mhz):
    ...
    ax.plot(combined_delta_iso, combined_intensity*0.35e4 + 1500, label='Theoretical', color='#2A9D8F', linestyle='dashed')
    ...
    ax_inset_1.plot(combined_delta_iso, combined_intensity*0.35e4 + 0.5e4, color='#2A9D8F', linestyle='dashed')
    ...
    ax_inset_2.plot(combined_delta_iso, combined_intensity*0.35e4 + 250, color='#2A9D8F', linestyle='dashed')
