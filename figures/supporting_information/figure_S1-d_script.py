...
ax.text(x=180, y=140, s=text[0] + f"$= {m11:.3f}$" + '$(30)$ ' + text[1], 
        color='#264653', fontsize=14.5)
ax.text(x=280, y=70, s=f'$R^2 = {results11.rsquared:.4f}$', 
        color='#264653', fontsize=14.5)

# Show plot
plt.tight_layout()
fig.savefig('19F_CSA_slop_RbTa2O5F_fixed_intercept.svg', format='svg', dpi=300, bbox_inches='tight')
plt.show()
