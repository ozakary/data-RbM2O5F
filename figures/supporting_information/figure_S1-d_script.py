...
data_1 = np.loadtxt("figure_S1-d_data.txt", skiprows = 1, usecols=(1, 2))
...
ax.text(x = 40, y = 140, s = text[0] + "$= {m:.3f}$".format(m=m11) + '$(36)$ ' + text[1] + ' $+$ ' + "${b:.1f}$".format(b=b11) + '$(14.6)$', color = '#264653', fontsize = 14.5)
ax.text(x = 280, y = 70, s = f'$R^2 = {results11.rsquared:.4f}$', color = '#264653', fontsize = 14.5)

# Show plot
plt.tight_layout()
fig.savefig('19F_CSA_slop_RbTa2O5F.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()
